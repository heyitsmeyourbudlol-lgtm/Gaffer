...
## Current snapshot (2026-09-09 06:02 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 17 today · proj 67.5/day · week_avg 13.0 (bar ≥8) [PASS] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/2 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #293 Agent packs hub + embed CORP distribution pins (after #292) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/293); #292 Embed.v2.js distribution crawl pins (after #291) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/292); #291 Paste-sites + embed MIME distribution pins (after #290) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/291); #290 Capability-URL noindex + crawl brief CORS (after #289) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/290); #289 Embed widget + agent-static distribution pins (after #288) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/289)
